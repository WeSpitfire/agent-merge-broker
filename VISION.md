...
### Gate mode — validation and evidence in 0.15.0
...
The `0.13.0` slice stopped at the saved validation result. Version `0.15.0` includes operational
...
authority. Gate approval, publication, reconciliation, pull-request intake, bundles, and authenticated
remote submission remain planned.
...
`candidate verify-attestation`, included in `0.15.0`, checks detached Gate validation evidence against explicit
